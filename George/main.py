...
def aprender_conceito(conceito, explicacao):
    with open('conceitos_matematicos.txt', 'a') as arquivo:
...
def comando_voz_usuario():
    ...
    elif 'procure por' in comando or 'quem é' in comando or 'george quem é' in comando or 'quem foi' in comando:
    ...
    #comando para tocar musicas no youtube
        ...
        nw = news
        maquina.say("Reproduzindo " + nw + " no YouTube")
        maquina.runAndWait()
comando_voz_usuario()